...
namespace TechLead_SGE.Server.Classes.Logic.Custom
{
    ...
    internal static class EmployeeLogic
    {
        ...
        /// <returns></returns>
        internal static async Task<ActionResult> GetEmployeesParams(InitConfig Init_Config, ValidationsInControllers Validations, IDependenciesContext Dependencies, Guid? EmployeeID = null)
        {
            try
            {
